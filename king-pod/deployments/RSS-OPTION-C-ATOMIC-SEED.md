...
1. **Morpho depth:** `idle = supplyAssets − borrowAssets` on RSS market ≥ `ASK_USDC` (600k–700k raw 6dp), supplied by desk; **or**
2. **Tenor offer:** live onchain lend offer vs RSS `0x7a305…` sized ≥ ask, ready for hot to accept in the same ops window.
