# Unit D — Curator listing packet (SUBMIT NOW — 2026-07-18 refresh)

**Status:** READY — oracle **admin burned** (`owner = dEaD`). PoD ~$9.25M @ 100% util. Ask `maxIn = $700k`.  
**Ops master:** `CURATOR-DOOR-OPS.md` · **Forum paste:** `FORUM-POST-STEAKHOUSE.md` / `FORUM-POST-GAUNTLET.md`  
**Depth gap (honest):** no RSS DEX pools yet — ask **High Yield / Core**, not Prime. Plan: `RSS-LIQUIDITY-DEPTH-PLAN.md`.
...
| Oracle | Morpho FixedOracle `0x284EC3A9674e6C62ea552Bf75BDeE9B799627D2e` — **$1 fixed**, owner **`0x…dEaD`** (immutable; lock tx `0x7b35b276…4726`) |
