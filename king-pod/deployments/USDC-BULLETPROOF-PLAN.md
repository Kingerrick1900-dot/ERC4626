...
**Primary sheet:** `FOUR-LIVE-AVENUES.md` — escrow fill is theater; these four are the cash paths.
...
| Step | Action | Owner |
|--|--|--|
| A1 | Ship Completer + Permit2 pull (signed allowance from matcher wallet) | Chief |
