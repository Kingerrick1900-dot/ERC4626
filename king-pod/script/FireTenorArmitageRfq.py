#!/usr/bin/env python3
"""DEPRECATED — Elepan RFQ path cancelled by King.

Use instead: FireTenorRssRfq500k.py (TRUE RSS 0x7a305…, $500k Option C).
This file kept only as historical reference; do not --fire Elepan.
"""
raise SystemExit(
    "DEPRECATED: Elepan RFQ cancelled. Use king-pod/script/FireTenorRssRfq500k.py"
)

# Historical docstring / body below is unreachable.
"""LEGACY Code-first Tenor OTC RFQ: $700k USDC borrow vs ELE → Armitage (Wintermute).
