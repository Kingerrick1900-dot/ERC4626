...
/// @notice Draw $700k USDC to Landing from RSS/$1200 when idle >= WANT. Phase 2 step 3.
/// @dev KING_OK=1. Reverts IDLE_LT_700K otherwise. No flash. No self-supply.
interface IERC20B {
...
contract BorrowIdleToLanding is Script {
    ...
    /// @dev $1200/RSS @ 77% LLTV: ~758 RSS for $700k; 850 RSS buffer.
    ...
    function run() external {
        ...
        IMorphoB.MarketParams memory mp = IMorphoB.MarketParams(USDC, RSS, ORACLE, IRM, LLTV);
        ...
        console2.log("BORROW_IDLE_LANDING_OK", uint256(1));
    }
}
