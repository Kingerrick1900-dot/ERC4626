...
contract FireLiveExitTest is Script {
    ...
    function run() external {
        ...
        console.log("LIVE_EXIT_PROVEN", assets);
        console.log("freer", address(freer));
        console.log("rssBefore", rssBefore);
        console.log("rssAfter", IERC20S(RSS).balanceOf(HOT));
        console.log("penalty", IVaultV2S(VAULT).forceDeallocatePenalty(ADAPTER));
        console.log("vaultTotalAssets", IVaultV2S(VAULT).totalAssets());
    }
}
